...
- **Blocking scan:** Phase 1 scan runs synchronously on the UI thread. For very large trees on slow disks the UI freezes during the scan; a future improvement would move it to a background thread.
